...
class creative_foundation extends CModule
{
    ...
    public function installFiles()
    {
        ...
        CopyDirFiles($this->getInstallatorPath() . '/templates', $this->getComponentPath('templates'), true, true);
    ...
    public function unInstallFiles()
    {
        ...
        if (is_dir($this->getInstallatorPath() . '/templates')) {
            self::deleteByEtalon($this->getInstallatorPath() . '/templates', $this->getComponentPath('templates'));
        }
